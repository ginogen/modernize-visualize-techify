...
const AIWorkflow = () => {
  ...
  const connections: Connection[] = [
    ...
    { from: "ai", to: "chat", animationDelay: 1 },
    { from: "chat", to: "shopify", animationDelay: 3 }
  ];

  // Predefined chat messages for the simulation
  const predefinedMessages: ChatMessage[] = [
    { id: 1, isUser: true, text: "I need to set up an online store" },
    { id: 2, isUser: false, text: "I can help with that! Connecting to Shopify..." },
    { id: 3, isUser: true, text: "What payment options can I integrate?" },
    { id: 4, isUser: false, text: "You can use MercadoPago and PayPal. Setting up connections..." },
    { id: 5, isUser: true, text: "Can I track my inventory?" },
    { id: 6, isUser: false, text: "Yes! I'll set up Google Sheets integration for your inventory tracking." },
    { id: 7, isUser: true, text: "Do you offer analytics?" },
    { id: 8, isUser: false, text: "Absolutely! Connecting to analytics services now." }
  ];
  ...
  return (
    <div className="w-full py-20 bg-darkBlue overflow-hidden" ref={containerRef}>
      ...
      <div className="relative max-w-5xl mx-auto flex flex-col md:flex-row items-center md:items-start gap-6 px-4">
        {/* Chat Interface */}
        <motion.div 
          className="w-full md:w-1/3 h-[300px] bg-gray-900/70 backdrop-blur-md rounded-xl border border-gray-700 shadow-lg overflow-hidden flex flex-col z-30"
        ...
        >
          ...
          <div className="bg-gray-800 p-3 border-t border-gray-700 flex items-center gap-2">
            <input 
              type="text" 
              className="w-full bg-gray-700 border border-gray-600 rounded-lg px-3 py-2 text-sm text-white placeholder-gray-400 focus:outline-none focus:ring-1 focus:ring-blue-500"
        ...
        <motion.div 
          className="relative h-[500px] md:h-[600px] w-full md:w-2/3"
