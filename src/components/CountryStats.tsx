...
const CountryStats = () => {
  ...
  return (
    <section className="section-padding bg-gradient-to-b from-darkBlue to-darkBlue/90 text-white relative overflow-hidden">
      <div className="container mx-auto">
        ...
        >
          <Badge 
            variant="outline" 
            className="mb-4 text-neonGreen border-neonGreen/30 bg-neonGreen/5 font-mono"
          >
          ...
          <p className="text-white/80 max-w-2xl mx-auto mb-6">
            {language === 'es' 
              ? 'Brindamos soluciones de IA y desarrollo personalizado a clientes en todo el mundo' 
              : 'We provide AI solutions and custom development to clients worldwide'}
          </p>
        </motion.div>
        ...
        >
          <Card className="bg-neonGreen/20 border-neonGreen/30 max-w-md mx-auto">
            <CardContent className="p-6 flex items-center justify-center gap-4">
              <MapPin className="text-neonGreen" size={28} />
              <div>
                <p className="font-mono text-sm text-white/70">
                  {language === 'es' ? 'TOTAL DE CLIENTES' : 'TOTAL CLIENTS'}
                </p>
                <p className="text-2xl font-bold font-mono">{totalClients}+</p>
              </div>
            </CardContent>
          </Card>
        </motion.div>
