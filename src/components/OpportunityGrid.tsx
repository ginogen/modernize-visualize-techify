      ...
      <div className="container mx-auto max-w-6xl px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Basado en nuestro análisis, hemos identificado áreas específicas
            donde podemos generar impacto inmediato en su negocio.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-12">
          ...
          {lead.automation_opportunities_array.length > 0 && (
            <Card className="p-8">
              ...
              <div className="space-y-3 mb-6">
                {lead.automation_opportunities_array
                  .slice(0, 5)
          ...
          {lead.sales_opportunities_array.length > 0 && (
            <Card className="p-8">
              ...
              <div className="space-y-3 mb-6">
                {lead.sales_opportunities_array
                  .slice(0, 5)
                  .map((opportunity, index) => (
                    <div
                      key={index}
              ...
              {lead.sales_opportunities_array.length > 5 && (
                <div className="text-sm text-gray-600 bg-gray-50 p-3 rounded-lg">
                  +{lead.sales_opportunities_array.length - 5} oportunidades
        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-12">
          ...
          {lead.security_recommendations_array.length > 0 && (
            <Card className="p-8">
              ...
              <div className="space-y-3">
                {lead.security_recommendations_array.map(
            ...
            <Card className="p-8">
              ...
              {lead.seo_opportunities_array.length > 5 && (
                <div className="text-sm text-gray-600 bg-gray-50 p-3 rounded-lg mt-3">
                  +{lead.seo_opportunities_array.length - 5} optimizaciones
                  adicionales identificadas
                </div>
              )}
            </Card>
        ...
        <Card className="p-8 bg-gradient-to-r from-blue-50 to-indigo-50 border-blue-200">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h3 className="text-xl font-semibold text-gray-900">
              Nuestra Propuesta de Valor para {lead.company_name}
            </h3>
          </div>
            ...
            <div className="flex flex-col md:flex-row items-center gap-6">
              ...
              <div className="text-center md:text-left">
                ...
                <p className="text-gray-700 leading-relaxed">
                  Este análisis fue verificado con nuestra tecnología
                  propietaria y confirmado por <strong>Gino Gentile</strong>,
                  fundador de Builders AI.
                </p>
              </div>
            </div>
          </Card>
        ...
        <div className="text-center mt-12">
          <div className="bg-gray-900 rounded-2xl p-8 md:p-12">
            ...
            <p className="text-gray-300 mb-8 max-w-2xl mx-auto">
              Agenda una llamada de 30 minutos para discutir cómo podemos
              implementar estas mejoras y acelerar el crecimiento de tu negocio.
            </p>
            <Button
