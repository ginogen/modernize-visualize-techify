    ...
    <section className="section-padding">
      <div className="container mx-auto">
        <div className="relative max-w-5xl mx-auto">
          ...
          <div className="absolute -z-10 top-1/2 right-1/4 w-64 h-64 bg-violet-500/20 rounded-full blur-3xl transform translate-x-1/2 -translate-y-1/2 opacity-60"></div>
          ...
          <div className="glass rounded-3xl overflow-hidden shadow-xl relative">
            ...
            <div className="p-8 md:p-12 lg:p-16">
              <div className="text-center max-w-3xl mx-auto">
                ...
                <p className="text-lg md:text-xl text-foreground/80 mb-8 animate-fade-in" style={{ animationDelay: "0.1s" }}>
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-fade-in" style={{ animationDelay: "0.2s" }}>
                  <Button className="button-glow px-8 py-6 text-lg" asChild>
                    <Link to="/contact">
