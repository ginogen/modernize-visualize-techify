...
const LandingBotServicios = () => {
  ...
  const options = [
    ...
    },
    {
      ...
      description:
        "Permite mantener el uso habitual de WhatsApp sin restricciones, aunque existe un leve riesgo de detección por parte de WhatsApp.",
      technologies: [
      ...
      additionalCosts: [
        "Evolution API: U$D 12/mes",
        "Servidor y base de datos: U$D 30/mes aprox.",
        "OpenAI: U$D 20/mes",
      ],
    ...
    },
    {
      ...
      description:
        "Este plan comprende la implementación de la opción 1 o 2, y además la transformación en su partner tecnológico.",
      includes: [
      ...
      objective:
        "Convertirnos en un socio tecnológico estratégico, acompañando a la empresa en cada iniciativa digital y de innovación.",
      implementation: {
        monthlyFee: "$850.000",
      },
  ...
  const handleSelectOption = (optionId: number) => {
    ...
    toast({
      ...
      description: `Has seleccionado la ${
    ...
    <div className="min-h-screen overflow-x-hidden bg-background">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="container mx-auto px-4 py-32 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              Bot con IA y{" "}
              <span className="text-neonGreen">Servicios Tecnológicos</span>
            </motion.h1>
            ...
            >
              Automatiza la atención al cliente, mejora la eficiencia y
              transforma tu negocio con nuestras soluciones inteligentes
            </motion.p>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              ...
              <span className="text-neonGreen">Bot con IA</span>?
            </h2>
          </motion.div>
            ...
            {[
              {
                ...
                title: "Atención 24/7",
                description:
                  "Responde a tus clientes en cualquier momento, sin descanso",
              ...
              },
              {
                ...
                description:
                  "Obtén insights valiosos sobre tus clientes y conversaciones",
              ...
              },
              {
                ...
                description:
                  "Ahorra hasta 80% en costos de atención al cliente",
              ...
              <motion.div key={index} variants={fadeInUp}>
                <Card className="h-full bg-card/50 backdrop-blur-sm border-border/50 hover:border-neonGreen/30 transition-all duration-300 hover:shadow-lg hover:shadow-neonGreen/10">
                  <CardContent className="p-6 text-center">
                    <div
                      className={`inline-flex items-center justify-center w-16 h-16 bg-neonGreen/10 rounded-xl mb-4 ${benefit.color}`}
                    >
                      {benefit.icon}
                    </div>
      ...
      <section id="options" className="py-20 bg-background section-enhanced-bg">
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              Elige la <span className="text-neonGreen">opción perfecta</span>{" "}
              para tu negocio
            </h2>
          </motion.div>
                ...
                >
                  <CardContent className="p-8">
                    ...
                    <div className="text-center mb-6">
                      <div
                        className={`inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r ${option.color} rounded-xl mb-4 text-white`}
                      >
                        {option.icon}
                      </div>
                    ...
                    {option.features && (
                      <div className="mb-6">
                        <h4 className="font-semibold mb-3 text-neonGreen">
                          Incluye:
                        </h4>
                    ...
                    <div className="border-t pt-6 mb-6">
                      ...
                      {option.implementation.investmentImplementation && (
                        <div className="flex items-center justify-between mb-2">
                          ...
                          <span className="font-semibold text-neonGreen">
                            {option.implementation.investmentImplementation}
                          </span>
                        </div>
                      )}
      ...
      <section className="py-20 bg-muted/30 section-enhanced-bg">
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              Tecnología de <span className="text-neonGreen">vanguardia</span>{" "}
              para tu negocio
            </h2>
          </motion.div>
            ...
            {[
              {
                ...
                description:
                  "Comprende el contexto y responde de manera natural y coherente",
              },
              {
                icon: <Smartphone className="h-6 w-6" />,
                title: "Multiplataforma",
                description:
                  "WhatsApp, Instagram, Facebook Messenger en una sola interfaz",
              },
              {
              ...
              },
              {
                ...
                description:
                  "Dashboards personalizados con métricas clave de tu negocio",
              },
              {
                icon: <HeadphonesIcon className="h-6 w-6" />,
                title: "Soporte Dedicado",
                description:
                  "Equipo técnico disponible para asistencia y mejoras continuas",
              },
              {
                icon: <Settings className="h-6 w-6" />,
                title: "Personalización Total",
                description:
                  "Adapta el bot a tu marca, tono y procesos específicos",
              },
            ].map((feature, index) => (
              <motion.div
                key={index}
      ...
      <section className="py-20 bg-gradient-to-r from-darkBlue to-darkBlue/90 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              ¿Listo para <span className="text-neonGreen">transformar</span> tu
              atención al cliente?
            </h2>
            <p className="text-xl text-white/80 mb-8 max-w-2xl mx-auto">
              Implementa un bot con IA y lleva tu negocio al siguiente nivel.
