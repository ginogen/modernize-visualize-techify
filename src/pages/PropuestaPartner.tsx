          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              <Badge className="bg-neonGreen/10 text-neonGreen border-neonGreen/20 px-4 py-2 text-sm font-mono">
                🤖 Bot Conversacional con IA - Partner
              </Badge>
            </motion.div>
            ...
            >
              Propuesta Bot <span className="text-neonGreen">Partner</span>
            </motion.h1>
          ...
          >
            <Card className="bg-gradient-to-br from-neonGreen/5 to-blue-500/5 border-neonGreen/20 backdrop-blur-sm">
              <CardContent className="p-8 text-center">
                ...
                <div className="text-4xl font-bold text-neonGreen mb-4">Desde $400.000</div>
      ...
      <section className="py-20 bg-muted/30 section-enhanced-bg">
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              Planes <span className="text-neonGreen">Mensuales</span> de Soporte
            </h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Mantén tu bot funcionando de manera óptima con nuestros planes de soporte continuo
            </p>
          </motion.div>
            ...
            >
                ...
                <Card className="bg-gradient-to-br from-blue-500/5 to-neonGreen/5 border-blue-500/20 backdrop-blur-sm">
                  <CardContent className="p-6">
                    <div className="flex items-center justify-between mb-4">
                      <h3 className="text-lg font-bold">Plan Base</h3>
                      <Badge className="bg-blue-500/10 text-blue-400 border-blue-500/20">Básico</Badge>
                    </div>
                    <div className="text-2xl font-bold text-neonGreen mb-2">USD $49</div>
                    <p className="text-muted-foreground mb-4">por mes</p>
                    <div className="bg-background/50 rounded-lg p-3 mb-4">
                      <div className="text-lg font-bold text-blue-400 mb-1">1.000</div>
                      <div className="text-xs text-muted-foreground">contactos mensuales incluidos</div>
                    </div>
                    <div className="space-y-2 text-sm">
                      <div className="flex items-center">
                        <CheckCircle className="h-3 w-3 text-neonGreen mr-2" />
              ...
              <motion.div variants={fadeInUp}>
                <Card className="bg-gradient-to-br from-neonGreen/5 to-blue-500/5 border-neonGreen/20 backdrop-blur-sm">
                  <CardContent className="p-6">
                    <div className="flex items-center justify-between mb-4">
                      <h3 className="text-lg font-bold">Plan Intermedio</h3>
                      <Badge className="bg-neonGreen/10 text-neonGreen border-neonGreen/20">Popular</Badge>
                    </div>
                    <div className="text-2xl font-bold text-neonGreen mb-2">USD $59</div>
                    <p className="text-muted-foreground mb-4">por mes</p>
                    <div className="bg-background/50 rounded-lg p-3 mb-4">
                      <div className="text-lg font-bold text-blue-400 mb-1">3.000</div>
                      <div className="text-xs text-muted-foreground">contactos mensuales incluidos</div>
                    </div>
                    <div className="space-y-2 text-sm">
                      <div className="flex items-center">
              ...
              {/* Plan Avanzado */}
              <motion.div variants={fadeInUp}>
                <Card className="bg-gradient-to-br from-purple-500/5 to-neonGreen/5 border-purple-500/20 backdrop-blur-sm">
                  <CardContent className="p-6">
                    <div className="flex items-center justify-between mb-4">
                      <h3 className="text-lg font-bold">Plan Avanzado</h3>
                      <Badge className="bg-purple-500/10 text-purple-400 border-purple-500/20">Premium</Badge>
                    </div>
                    <div className="text-2xl font-bold text-neonGreen mb-2">USD $99</div>
                    <p className="text-muted-foreground mb-4">por mes</p>
                    <div className="bg-background/50 rounded-lg p-3 mb-4">
                      <div className="text-lg font-bold text-blue-400 mb-1">10.000</div>
                      <div className="text-xs text-muted-foreground">contactos mensuales incluidos</div>
                    </div>
                    <div className="space-y-2 text-sm">
                      <div className="flex items-center">
...
export default PropuestaPartner; 