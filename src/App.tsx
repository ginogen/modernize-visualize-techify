...
import PropuestaMGGroupDataCloud from "./pages/PropuestaMGGroupDataCloud";
            ...
            <AuthProvider>
              <Router>
                <Routes>
                  ...
                  />
                  <Route
                    path="/propuesta-rosario-pack"
                    element={<PropuestaRosarioPack />}
                  />
                  <Route
                    path="/propuesta-luco"
                  ...
                  />
                  <Route
                    path="/propuesta-mg-group-data-cloud"
                    element={<PropuestaMGGroupDataCloud />}
                  />
                  <Route
                    path="/ev-contadores"
                    element={<LandingEVContadores />}
                  />
